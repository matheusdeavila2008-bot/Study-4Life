...
const mundosQuiz = [
  {
    ...
    descricao:
      "Aprenda introdução, desenvolvimento, conclusão, tese e organização do texto no modelo ENEM.",
    fases: [
      {
  ...
  },
  {
    ...
    titulo: "Argumentação",
    descricao:
      "Treine repertórios, argumentos, conectivos, coerência, coesão e defesa de ponto de vista.",
    fases: [
      {
