...
const mundosQuiz = [
  {
    ...
    descricao: "Conheça as primeiras civilizações, sociedades antigas, impérios, cultura e organização política.",
    fases: [
      {
  ...
  },
  {
    ...
    descricao: "Explore feudalismo, Igreja, cruzadas, cultura medieval e transformações sociais.",
    fases: [
      {
