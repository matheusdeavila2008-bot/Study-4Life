...
const mundosQuiz = [
  {
    ...
    titulo: "Programação",
    descricao:
      "Aprenda lógica, HTML, CSS, JavaScript, algoritmos e fundamentos para criar seus próprios projetos.",
    fases: [
      {
  ...
  },
  {
    ...
    descricao:
      "Explore inteligência artificial, automação, segurança digital, dados e tendências do mundo tecnológico.",
    fases: [
      {
