...
const mundosQuiz = [
  {
    ...
    titulo: "Ética",
    descricao:
      "Reflita sobre ações humanas, valores, moral, escolhas, liberdade e responsabilidade.",
    fases: [
      {
  ...
  },
  {
    ...
    titulo: "Lógica",
    descricao:
      "Treine argumentação, raciocínio, premissas, conclusões, falácias e pensamento crítico.",
    fases: [
      {
