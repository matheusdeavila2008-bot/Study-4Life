...
// mapa de fases - filosofia
const mundosQuiz = [
  {
    capitulo: "Capítulo 1",
    titulo: "Ética",
    descricao: "Reflita sobre ações humanas, valores, moral, escolhas e responsabilidade.",
    fases: [
      {
        id: "filosofia-etica-lvl-1",
        titulo: "Moral e Ética",
        descricao: "Entenda a diferença entre ética, moral, valores e costumes.",
        icone: "⚖️",
        xp: 1000,
        url: "indexPerguntasFilosofia.html",
      },
      {
        id: "filosofia-etica-lvl-2",
        titulo: "Ação Humana",
        descricao: "Analise escolhas, liberdade, responsabilidade e consequências.",
        icone: "🧭",
        xp: 1200,
        url: "#",
      },
      {
        id: "filosofia-etica-lvl-3",
        titulo: "Teorias Éticas",
        descricao: "Conheça ideias como virtude, dever, utilidade e justiça.",
        icone: "📜",
        xp: 1500,
        url: "#",
      },
      {
        id: "filosofia-etica-boss",
        titulo: "Chefão Ético",
        descricao: "Desafio final de ética.",
        icone: "👑",
        xp: 2000,
        url: "#",
      },
  ...
  },
  {
    capitulo: "Capítulo 2",
    titulo: "Lógica",
    descricao: "Treine argumentação, raciocínio, premissas, conclusões e pensamento crítico.",
    fases: [
      {
        id: "filosofia-logica-lvl-1",
        titulo: "Argumentos",
        descricao: "Aprenda o que são premissas, conclusões e validade.",
        icone: "🧠",
        xp: 1000,
        url: "#",
      },
      {
        id: "filosofia-logica-lvl-2",
        titulo: "Falácias",
        descricao: "Identifique erros de raciocínio em argumentos.",
        icone: "🕳️",
        xp: 1200,
        url: "#",
      },
      {
        id: "filosofia-logica-lvl-3",
        titulo: "Raciocínio Crítico",
        descricao: "Avalie ideias, opiniões e argumentos de forma lógica.",
        icone: "🔍",
        xp: 1500,
        url: "#",
      },
      {
        id: "filosofia-logica-boss",
        titulo: "Chefão Lógico",
        descricao: "Desafio final de lógica.",
        icone: "🏆",
        xp: 2000,
        url: "#",
      },
