...
// mapa de fases - geografia
const mundosQuiz = [
  {
    capitulo: "Capítulo 1",
    titulo: "Geografia Física",
    descricao: "Aprenda sobre relevo, clima, vegetação, hidrografia, solo e fenômenos naturais.",
    fases: [
      {
        id: "geografia-fisica-lvl-1",
        titulo: "Relevo e Paisagens",
        descricao: "Conheça montanhas, planaltos, planícies, depressões e formas do relevo.",
        icone: "⛰️",
        xp: 1000,
        url: "indexPerguntasGeografia.html",
      },
      {
        id: "geografia-fisica-lvl-2",
        titulo: "Clima",
        descricao: "Entenda temperatura, chuva, massas de ar e tipos climáticos.",
        icone: "🌦️",
        xp: 1200,
        url: "#",
      },
      {
        id: "geografia-fisica-lvl-3",
        titulo: "Hidrografia",
        descricao: "Estude rios, bacias hidrográficas, oceanos e recursos hídricos.",
        icone: "🌊",
        xp: 1500,
        url: "#",
      },
      {
        id: "geografia-fisica-boss",
        titulo: "Chefão da Natureza",
        descricao: "Desafio final de geografia física.",
        icone: "👑",
        xp: 2000,
        url: "#",
      },
  ...
  },
  {
    capitulo: "Capítulo 2",
    titulo: "Demografia",
    descricao: "Explore população, crescimento demográfico, migrações, urbanização e sociedade.",
    fases: [
      {
        id: "geografia-demografia-lvl-1",
        titulo: "População",
        descricao: "Entenda população absoluta, relativa e distribuição populacional.",
        icone: "🌍",
        xp: 1000,
        url: "#",
      },
      {
        id: "geografia-demografia-lvl-2",
        titulo: "Crescimento Populacional",
        descricao: "Aprenda natalidade, mortalidade e crescimento vegetativo.",
        icone: "📊",
        xp: 1200,
        url: "#",
      },
      {
        id: "geografia-demografia-lvl-3",
        titulo: "Migrações",
        descricao: "Estude deslocamentos populacionais, causas e consequências.",
        icone: "🧭",
        xp: 1500,
        url: "#",
      },
      {
        id: "geografia-demografia-boss",
        titulo: "Chefão Demográfico",
        descricao: "Desafio final de demografia.",
        icone: "🏆",
        xp: 2000,
        url: "#",
      },
