...
const mundosQuiz = [
  {
    ...
    titulo: "Citologia",
    descricao:
      "Entenda a estrutura das células, organelas, membrana plasmática e processos celulares.",
    fases: [
      {
  ...
  },
  {
    ...
    titulo: "Histologia",
    descricao:
      "Explore os tecidos do corpo, suas funções e como eles formam órgãos e sistemas.",
    fases: [
      {
