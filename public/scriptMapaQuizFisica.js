...
const mundosQuiz = [
  {
    ...
    titulo: "Mecânica",
    descricao:
      "Aprenda movimento, velocidade, aceleração, força, leis de Newton e energia mecânica.",
    fases: [
      {
  ...
  },
  {
    ...
    titulo: "Termologia",
    descricao:
      "Explore temperatura, calor, dilatação térmica, mudanças de estado e trocas de energia.",
    fases: [
      {
