...
const mundosQuiz = [
  {
    ...
    descricao:
      "Aprenda matéria, propriedades, substâncias, misturas, transformações e conceitos fundamentais.",
    fases: [
      {
  ...
  },
  {
    ...
    descricao:
      "Explore átomos, partículas subatômicas, modelos atômicos, número atômico e massa.",
    fases: [
      {
